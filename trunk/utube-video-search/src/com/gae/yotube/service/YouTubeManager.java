...
public class YouTubeManager {
	...
	public List<YouTubeVideo> retrieveVideos(String textQuery, int maxResults, 
		...
		query.setFullTextQuery("full length movies");
		//query.setSafeSearch(YouTubeQuery.SafeSearch.NONE);
		query.setFields("fields=entry(media:group(media:thumbnail(@url)))");
		//query.setAuthor("teluguone");
		//query.setStringCustomParameter("keyword", "telugu");
...
//	public GDataRequest  getGDataRequest(String url){
